...
<body>
    <main style="background:rgb(252,251,248);min-height: 1500px;">
    <div class="Painel">
    <img class="imgPerfil" src="assets/telainicio.png"/>
    ...
    <ul class="logo" style="top: 1580px;"><img class="union-1" src="assets/Vector.png" />
    <img class="se-joga-2022" src="assets/Se joga2022.png"/></ul>
    <div class="rodape" style=" position:relative;top: -990px;">
                <ul>
